...
return the skyline formed by these buildings collectively. The geometric information of 
each building is given in the array buildings where buildings[i] = [lefti, righti, heighti]:
...
and is used to mark the skyline's termination where the rightmost building ends. Any 
